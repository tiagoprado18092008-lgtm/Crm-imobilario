...
router.get('/', requireRole('SUPER_ADMIN', 'AGENCY_OWNER', 'AGENCY_ADMIN'), ctrl.list);
router.post('/', requireRole('SUPER_ADMIN', 'AGENCY_OWNER', 'AGENCY_ADMIN'), validate(createInvitationSchema), ctrl.create);
